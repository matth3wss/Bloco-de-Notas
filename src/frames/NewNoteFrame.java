...
// new String[] { "Prioridade", "Urgente", "Alta", "Média", "Baixa", "Opcional",
// "Trivial" }));
// newNotePriority.setToolTipText("Prioridade");
// newNotePriority.setCursor(new
...
// reminderDateLabel.setText("Data: " +
// sdf.formatSqlDate(newNote.getDateCreated()));
...
// newNoteTitle.getText().equals("Título")) {
// newNoteDescription.setForeground(Color.LIGHT_GRAY);
// newNoteTitle.setForeground(Color.LIGHT_GRAY);
// }
// }// GEN-LAST:event_formWindowActivated

// private void newNoteDescriptionKeyPressed(java.awt.event.KeyEvent evt) {//
// GEN-FIRST:event_newNoteDescriptionKeyPressed
// if (newNoteDescription.getText().equals("Descrição")) {
...
// private void newNoteTitleKeyPressed(java.awt.event.KeyEvent evt) {//
// GEN-FIRST:event_newNoteTitleKeyPressed
...
// private void newNoteTitleMousePressed(java.awt.event.MouseEvent evt) {//
// GEN-FIRST:event_newNoteTitleMousePressed
// if (newNoteTitle.getText().equals("Título")) {
...
// GEN-FIRST:event_btnAddNoteActionPerformed
...
// java.util.logging.Logger.getLogger(NewNoteFrame.class.getName()).log(java.util.logging.Level.SEVERE,
// null,
// ex);
// }
// // </editor-fold>
